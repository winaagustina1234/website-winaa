...
<head>
    ...
    <title><?php echo $id ? 'Edit Buku' : 'Tambah Buku Baru'; ?></title>
    ...
    <style>
        ...
        body {
            ...
            /* Warna latar belakang lembut merah muda */
            color: #333;
        }
...
<body>
    <header>
        <h1><?php echo $id ? 'Edit Buku' : 'Tambah Buku Baru'; ?></h1>
    </header>
    ...
    <main>
        <form action="save.php" method="POST">
            ...
            <input type="text" name="penulis" id="penulis" value="<?php echo $penulis; ?>" required>
